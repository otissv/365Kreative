...
export default function Contact({ className, ...props }: SectionProps) {
  ...
  return (
    <Section className={cn('section', className)} {...props}>
      <div className="Section-content-wrapper">
        <SectionWatermark>{contact.title}</SectionWatermark>
        <div className="Section-container Section-content-main xl:grid xl:grid-cols-2">
          <div>
            <SectionHeading
              className="mb-8"
            ...
            <Box
              className="grid gap-2 mb-6 translate-y-40 duration-500 delay-10"
              enter="translate-y-0"
            >
          ...
          <Box
            as="form"
            className={cn(
              'bg-background-3 border rounded-sm p-4 flex flex-col gap-6 translate-y-40 duration-500 delay-100',
